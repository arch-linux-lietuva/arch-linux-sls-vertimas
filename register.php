...
// Language definitions used in register.php TODO
$lang_register = array(

// Miscellaneous
'No new regs'				=>	'Bendruomenei nereikia naujų narių. :)',
'Reg cancel redirect'		=>	'Registracijos būsena: atšaukta. Perkeliama …',
'Forum rules'				=>	'Bendruomenės taisyklės',
'Rules legend'				=>	'Jūs turite sutikti su taisyklėmis',
'Registration flood'		=>	'Naujas vartotojas jau yra užsiregistravęs su nurodytu IP valandos bėgyje. Prašome palaukti ir vėliau vėl pabandyti. Atleiskite, už nepatogumus.',
'Agree'						=>	'Sutinku',
'Cancel'					=>	'Atšaukti',
'Register'					=>	'Užsiregistruoti',

// Form validation stuff (some of these are also used in post.php)
'Registration errors'		=>	'Registracijos klaidos',
'Registration errors info'	=>	'Sekančios klaidos turi būti ištaisytos, prieš tęsiant registraciją:',
...
'Confirm email'				=>	'Patvirtinkite elektroninį paštą',
